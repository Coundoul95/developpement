...
public interface AutreInfoService {
     ...
     */
    AutreInfoDTO updateAutreInfo(AutreInfoDTO autreInfo);
     ...
     */
    Page<AutreInfoDTO> readAllAutreInfos(String categorie, String importance, String description, Pageable pageable);
}
